			...
			*/
			...
			for(String unknown : unknowns)
			{
				...
				for(int temp = 0;temp < HMDBList.size();temp++)
				{
					...
					{
						results.println(unknown + ": Name: "+HMDBMetabolite.getElementsByTagName("Name").item(0).getTextContent());
						found = true;
						break;
					}
				...
				for(int temp = 0; temp < KEGGList.size();temp++)
				{
					...
					{
						//update results
						results.println(unknown + ": Name: "+KEGGMetabolite.getElementsByTagName("Name").item(0).getTextContent());
						found = true;
						break;
					}
				...
				for(int temp = 0; temp < NISTList.size();temp++)
				{
					...
					{
						//update results
						results.println(unknown + ": Name: "+NISTMetabolite.getElementsByTagName("Name").item(0).getTextContent());
						found = true;
						break;
					}
